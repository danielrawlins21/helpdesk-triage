      ...
      <div className="mt-4 flex justify-center">
        {qrSrc ? (
          <img
            ...
            className="h-64 w-64 rounded-3xl border border-slate-200 bg-white p-3 shadow-sm"
          />
        ) : (
          <div className="flex h-64 w-64 items-center justify-center rounded-3xl border border-dashed border-slate-300 bg-slate-50 px-6 text-sm text-slate-500">
